                                                        ...
                                                        <div class="tab-content">
                                                                ...
                                                                <form action="./ServletPassChanging" method="post">
                                                                    <div class="card-body pb-2">
                                                                        <% String successMessage=(String)
                                                                            request.getAttribute("success"); String
                                                                            errorMessage=(String)
                                                                            request.getAttribute("error"); Boolean
                                                                                            ...
                                                                                            <% for (Order order :
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <% if
                                                                                                        ...
                                                                                                        <td><span
                                                                                                                class="badge bg-light text-dark">Đang
                                                                                                                giao
                                                                                                                hàng</span>
                                                                                                        </td>
                                                                                                        <td>
                                                                                                            <%=OrderDAO.showResult_isVerifyOrder(order.getId())%>
                                                                                                        </td>
                                                                    ...
                                                                    <div class="card mb-4">
                                                                        ...
                                                                        <div class="card-body">
                                                                            ...
                                                                            <div class="mt-3">
                                                                                ...
                                                                                <a href="assets/signatureapp.exe"
                                                                                    download class="btn btn-info ms-2">
                                                            ...
                                                            <div class="modal fade" id="requestKeyModal" tabindex="-1">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title">Yêu cầu khóa mới
                                                                            </h5>
                                                                            <button type="button" class="btn-close"
                                                                                data-bs-dismiss="modal"></button>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <p>Bạn có muốn yêu cầu khóa mới không? Yêu
                                                                            ...
                                                                            <div class="alert alert-info">
                                                                                ...
                                                                                khóa mới.
                                                                                Khóa hiện tại của bạn sẽ vẫn hoạt động
